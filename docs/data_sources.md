...
| Taipei City administrative district boundaries (鄉鎮市區界) | District polygons for the spatial station-to-district join | https://data.gov.tw/dataset/7441 | county name, town name, geometry | Download the SHP/zip from the MOI Department of Land Administration and load with DuckDB `ST_Read` | Use the village boundary map and aggregate up to district |
| Taipei City announced land value by district (公告地價/現值) | Real-estate cost index input | https://data.gov.tw/dataset/26859 | district, announced land value | Download CSV from the Taipei City Government Department of Land Administration and average by district | Use the real-price registration batch data instead |
...
| `data/raw/taipei_districts.zip` | https://data.gov.tw/dataset/7441 | https://data.moi.gov.tw/MoiOD/System/DownloadFile.aspx?DATA=72874C55-884D-4CEA-B7D6-F60B0BE85AB0 | Open Government Data License, version 1.0 | Agency: Ministry of the Interior, Department of Land Administration. Administrative district boundary shapefile/zip, filtered in DuckDB to `臺北市` district polygons via `ST_Read`; used for the spatial point-in-district join that resolves each MRT station to a district. |
| `data/raw/land_value_by_district.csv` | https://data.gov.tw/dataset/26859 | https://data.taipei/api/dataset/placeholder/resource/placeholder/download | Open Government Data License, version 1.0 | Agency: Department of Land Administration, Taipei City Government. Announced land value (公告地價/現值) CSV, averaged by district in DuckDB and min-max scaled to the `[50, 100]` range to produce `real_estate_cost_index`. |
